...
public class Reports implements Initializable {
	...
	@FXML TableView<Reports> tv;
	@FXML TableColumn<Reports, String> invoice_no, invoice_date;
	@FXML TableColumn<Reports, Double> cgst_amt, sgst_amt, tot_gst_amt, tot_amt;
	Alert alert;
	...
	public Reports(String invoice_no2, String invoice_date2, Double cgst_amt2, Double sgst_amt2, Double tot_gst_amt2,
			Double tot_amt2) {
		super();
	...
	public void populateTable(ResultSet rs) {
		Double total = 0.0;
		ObservableList<Reports> ob1 = FXCollections.observableArrayList();
		
		try {
			while(rs.next()) {
				Reports reports = new Reports(rs.getString(1), rs.getString(2), rs.getDouble(3), 
		...
		invoice_no.setCellValueFactory(new PropertyValueFactory<Reports, String>("invoice_no2"));
		invoice_date.setCellValueFactory(new PropertyValueFactory<Reports, String>("invoice_date2"));
		cgst_amt.setCellValueFactory(new PropertyValueFactory<Reports, Double>("cgst_amt2"));
		sgst_amt.setCellValueFactory(new PropertyValueFactory<Reports, Double>("sgst_amt2"));
		tot_gst_amt.setCellValueFactory(new PropertyValueFactory<Reports, Double>("tot_gst_amt2"));
		tot_amt.setCellValueFactory(new PropertyValueFactory<Reports, Double>("tot_amt2"));
